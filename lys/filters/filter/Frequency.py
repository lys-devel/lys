...
class _FourierSetting(FilterSettingBase):
    def __init__(self, dim):
        ...
        self._layout.addWidget(QtWidgets.QLabel('Direction'), 0, 0)
        self._layout.addWidget(QtWidgets.QLabel('Process'), 0, 1)
        self._layout.addWidget(QtWidgets.QLabel('Window'), 0, 2)
        self._layout.addWidget(QtWidgets.QLabel('Axes'), 0, 3)
